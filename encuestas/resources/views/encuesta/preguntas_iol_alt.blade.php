																...
																<div class="container">
																	<div class="row">																
																		<div class="form-group" align="center">
																			<label style="margin-left: 30%; position: relative; text-align: center; margin:0; border: 0px solid green; width:30%">
																				<label for="happy_<?php echo $data2->id; ?>_<?php echo $indice; ?>" class="col-sm-4 col-md-4 control-label text-right" style="font-size: 15pt;"><?php echo trim($data2->opcion); ?></label>
