...
@include('layout.header')
    ...
    {!! Form::open(array('url' => 'consultar_encuesta', 'onsubmit'=>'Javascript: prox_pagina()', 'method' => 'get', 'class' =>  "form-horizontal", 'files'=>true)) !!}
        ...
        <div class="row">
			...
			<div class="col-md-7">
				...
				<!--a href="javascript:;" onclick="exportar({{ $id_bateria }})">
					<button class="btn btn-danger" type="button">Exportar reporte completo</button>
				</a-->
				</div>
				<div class="form-group" align="left">
				<?php
					echo FuncionesControllers::buscar_pruebas_reportes($id_tipo_prueba,$fecha_reporte2,$fecha_reporte1);
				?>
				</div>				
			</div>
		</div>
	<?php if (isset($fecha_reporte1)) { ?>
		<div class="form-group">
			@include($reporte, ['id_bateria'=>$id_bateria, 'id_tipo_prueba' => $id_tipo_prueba, 'nombre_prueba'=>$nombre_prueba, 'id_grupo_candidatos'=>$id_grupo_candidatos])
		</div>
	<?php } ?>
