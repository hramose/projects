...
<div id="xxx"></div>
<!-- INSTRUCCIONES -->
<div id="instrucciones" align="center" style="display:inline; border: 0px solid green;">
	<?php
					...
					<table border=0 width="250%" align="center">
						...
						<tr>
							...
							<td align="center">
								<!--PREGUNTAS-->
								<?php 
									$sql = "select * from preguntas_hl where id_pruebas=1 and id_preguntas<3 order by orden";
									//echo $sql;
									$data=DB::select($sql);
									$cantidad=1;
									$index_cantidad=0;
									...
									foreach ($data as $data) {
										...
										<div align="center" style="display: {{ $display }};" id="prueba{{ $cantidad }}">
											...
											for ($i=0; $i<count($pregunta); $i++) {
												...
												echo "<td><input autocomplete='off' autofocus='".$autofocus."' tabindex=".$tabindex." width='35px' height='35px' class='clase_textos_ejemplo_co' maxlength='2' style='width:50px; text-align: center' type='text' name='".$pregunta[$i]."-".$respuesta."' id='coord_".$id_pregunta."_".$complemento."' value='$valor'></td>";
												$tabindex++;
