...
<span class="header_tit1">C</span><span class="header_tit2">apacidad de</span> <span class="header_tit1">C</span><span class="header_tit2">oordinaci&oacute;n</span></div>
					...
					<table border=0 width="250%" align="center">
						...
						<tr>
							...
							<td align="center">
								<!--PREGUNTAS-->
								<?php 
									$sql = "select * from preguntas_hl where id_pruebas=1 and id_preguntas>9 order by orden";
									//echo $sql;
									$data=DB::select($sql);
									$cantidad=1;
									$index_cantidad=0;
