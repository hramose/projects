...
<script>preguntas=new Array(); nro_prueba=2; id_au=<?=$id_au?>; primera=new Array(); var num_actual=0; tabindex=1; var cantidad=0;</script>
...
<div id="prueba{{ $tabindex }}" style="display: {{ $display }};">
	...
	<div id="prueba2_sl_cont4" style="padding-left:60px;" style="border: 0px solid green; padding-left:30px;">
		<strong>Seleccione la opci&oacute;n que considere mas adecuada...</strong>
		<div id="prueba2_sl_cont5" style="text-align: center; width: 100%;">
<?php
		$sql = "select * from ".$tabla_opciones." where id_pregunta=".$data->id_preguntas;
