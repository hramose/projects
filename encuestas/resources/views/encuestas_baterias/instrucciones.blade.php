...
<div id="contenido_inst" style="border: 0px solid red; position:absolute; height:100%;">
	...
	<div id="cont1" align="justify" style="margin-left:25px; height:100%; border: 0px solid green; width:80%; float:left;">
		...
		//echo "<br>despues=$instrucciones_despues";			
			...
			if ($nro_inst==-1) {
				?>
					<div id="encuesta_ejemplo" style="display:inline;">
					<div id="cont3">
			...
			//echo "<div id='inst_desp' style='border:2px solid green; width: 90%; height:70%; position: absolute;'>";
			
		//echo "<br>333.antes=$instrucciones_antes";
		//echo "<br>333.despues=$instrucciones_despues";	
		
			echo $instrucciones_despues;
			
				if ($boton==="1") {
					?>
						<div id="button_continuar" style='position:relative; margin-left:5%; width:80%; text-align:center;  border: 0px solid red;'>
