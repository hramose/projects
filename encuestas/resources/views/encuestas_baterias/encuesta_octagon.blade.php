...
<span class="header_tit1">O</span><span class="header_tit2">ctagon</span> <span class="header_tit1"></span><span class="header_tit2"></span> <span class="header_tit1"></span><span class="header_tit2"></span></div>
...
<div id="instrucciones" align="center" style="display:inline;">
	<?php
		...
		//echo "<br>antes=$instrucciones_antes";
		//echo "<br>despues=$instrucciones_despues";
	?>

	@include('encuestas_baterias.instrucciones',["boton"=> "1", "id_au"=>$id_au, "nro_inst"=>13, "titulo"=>$titulo,"instrucciones_antes"=>$instrucciones_antes,"instrucciones_despues"=>$instrucciones_despues, "tiempo"=>$tiempo, "funcion"=>"guardar_encuesta_iep"])
...
<div id="encuesta" style="display:none;">
	...
	<?php
		...
		elseif (strpos(strtolower($nombre_bateria),"hi") !== false)
			...
			$sql = "select * from ".$tabla_preguntas." where id_pruebas=$orden and id_bateria=$id_bateria order by orden";
		//echo $sql; return;
		$data=DB::select($sql);
		...
		<div id="prueba3_sl_cont1">
			<div id="prueba3_sl_cont">
				...
				<div id="prueba1_pc_contIEP">
					...
					$sql = "select * from ".$tabla_opciones." 
						where id_pregunta=".$data->id_preguntas;
					//echo $sql;
