...
class FuncionesControllers extends Controller {
	...
	public static function buscar_pruebas_reportes($id,$fecha_reporte2,$fecha_reporte1) {
		$sql = "select tp.* 
				from tipos_pruebas tp, bateria b, bateria_tipo_prueba btp
				where b.id=".$id." and btp.id_tipo_prueba=tp.id and 
					btp.id_bateria=b.id order by btp.orden";
		//echo $sql;
		$data=DB::select($sql);
		$texto="<ul>";
		...
		$fecha_reporte1=str_replace("/","-",$fecha_reporte1);
		$fecha_reporte2=str_replace("/","-",$fecha_reporte2);

		foreach ($data as $data) {
			if (strpos(strtolower($data->nombre),"parte 1") === false && 
					strpos(strtolower($data->nombre),"primera parte (cc)") === false && 
					strpos(strtolower($data->nombre),"instrucciones") === false && 
					strpos(strtolower($data->nombre),"ejemplo") === false)
				$texto.="<li><a href='".$ruta."imprimir_excel/".$id.".".$fecha_reporte1.".".$fecha_reporte2.".".$data->id."'><button class='btn btn-success' type='button'>Reporte: ".$data->nombre."</button></a></li>";
		}
		$texto.="</ul>";
		echo $texto;
	}	
	...
	public static function prueba_inter($i) {
		...
		if ($i==2) {
			...
			$resultado = "<div align='center' style='border: solid 2px; border-color: blue; width: 100%; border-radius: 15px 50px 30px; margin: 5px; padding: 5px;'>";
			$resultado = "<table border=0 width='70%' align='center'><tr><td width='90%'>";
			$resultado.="
						<table border=0 width='100%' align='center'>
							<tr height='30px' valign='top'>
								<td align='right'><strong><h2>lengua</h2></strong></td>
								<td width='15%' align='center'><span style='color: blue'><h2>es a</h2></span></td>
								<td width='50%'><strong><h2>gustar</h2></strong></td>
							<tr>
							<tr height='30px'>
								<td align='right'><strong><h2>&nbsp;</h2></strong></td>
								<td width='15%' align='left'><div align='center'><span style='color: blue'><h2>como</h2></span></div></td>
								<td align='right'><strong><h2>&nbsp;</h2></strong></td>
							</tr>
							<tr height='30px'>
								<td align='right'><strong><h2>nariz</h2></strong></td>
								<td align='center'><span style='color: blue'><h2>es a</h2></span></td>
								<td colspan='3'><h2><span width='30px' style='color: blue;' width='30px' id='respuesta'></span></h2W></td>
							</tr>
						</table>
					";	
			//$i--;
			...
			$resultado.="<tr><td>";
			$resultado.='<button style="width: 200%;" type="button" onclick="colocar_test(0,\'sentir\', this.value, '.$i.', this.name)" class="prueba1">sentir</button></td></tr>';
			
			//<input type='radio' name='op' id='op' value='1' onclick='colocar_test(0,\"sentir\", this.value, $i, this.name)'></td></tr>";
			
			$resultado.="<tr><td>";
			$resultado.='<button style="width: 200%;" type="button" onclick="colocar_test(0,\'respirar\', this.value, '.$i.', this.name)" class="prueba1">respirar</button></td></tr>';
			
			//<input type='radio' name='op' id='op' value='2' onclick='colocar_test(0,\"respirar\", this.value, $i, this.name)'></td></tr>";
			
			$resultado.="<tr><td>";
			$resultado.='<button style="width: 200%;" type="button" onclick="colocar_test(0,\'exhalar\', this.value, '.$i.', this.name)" class="prueba1">exhalar</button></td></tr>';
			//<input type='radio' name='op' id='op' value='3' onclick='colocar_test(0,\"exhalar\", this.value, $i, this.name)'></td></tr>";
			
			$resultado.="<tr><td>";
			$resultado.='<button style="width: 200%;" type="button" onclick="colocar_test(1,\'oler\', this.value, '.$i.', this.name)" class="prueba1">oler</button></td></tr>';
			//<input type='radio' name='op' id='op' value='4' onclick='colocar_test(1,\"oler\", this.value, $i, this.name)'></td></tr>";
			...
			$resultado = '
				<div id="prueba" style="border: solid 0px; border-color: red; width:70%; float:left;">
					...
					<div align="left" style="margin-left:7%;"><strong>Seleccione la opci&oacute;n que considere mas adecuada...</strong></div>
			...
			$resultado = '
			<div id="prueba" style="top: 0; display:inline; border: 0px solid red;">
				<div id="prueba3_sl_preg" style="width:100%;">Al definir una estrategia, conviene que el mercado clave:</div>
				<br><br><br>
				<div id="prueba1_pc_cont">				
					<div id="prueba1_pc_resp">
						<div id="prueba1_pc_txt" class="clase_iep">Incluya el mayor rango posible.
							<label id="label_menos_1" for="label_menos_1" style="float: right; position: relative; top:0px; margin: 0; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
								&nbsp;&nbsp;&nbsp;
								<input src="../imagenes/negativo.gif" class="radio_iol" name="menos" id="menos" value="1" onmousedown="colocar_respuesta_ejemplo(\'iep_menos\',\'1\',\'\', this)" type="image" width="30" height="30">
								&nbsp;&nbsp;&nbsp;
					...
					<br><br>
					<div id="prueba1_pc_resp">
						<div id="prueba1_pc_txt" class="clase_iep">Se circunscriba al ya conocido.				
							<label id="label_menos_2" for="label_menos_1" style="float: right; position: relative; top:0px; margin: 0; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
								&nbsp;&nbsp;&nbsp;
								<input src="../imagenes/negativo.gif" class="radio_iol" name="menos" id="menos" value="2" onmousedown="colocar_respuesta_ejemplo(\'iep_menos\',\'2\',\'\', this)" type="image" width="30" height="30">
								&nbsp;&nbsp;&nbsp;
					...
					<br><br>
					<div id="prueba1_pc_resp">
						<div id="prueba1_pc_txt" class="clase_iep">Incorpore algun nuevo nicho.
							<label id="label_menos_3" for="label_menos_3" style="float: right; position: relative; top:0px; margin: 0; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
								&nbsp;&nbsp;&nbsp;
								<input src="../imagenes/negativo.gif" class="radio_iol" name="menos" id="menos" value="3" onmousedown="colocar_respuesta_ejemplo(\'iep_menos\',\'3\',\'\', this)" type="image" width="30" height="30">
								&nbsp;&nbsp;&nbsp;
					...
					<br><br>
					<div id="prueba1_pc_resp">
						<div id="prueba1_pc_txt" class="clase_iep">Se redimensione radicalmente.
							<label id="label_menos_4" for="label_menos_4" style="float: right; position: relative; top:0px; margin: 0; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
								&nbsp;&nbsp;&nbsp;
								<input src="../imagenes/negativo.gif" class="radio_iol" name="menos" id="menos" value="4" onmousedown="colocar_respuesta_ejemplo(\'iep_menos\',\'4\',\'\', this)" type="image" width="30" height="30">
								&nbsp;&nbsp;&nbsp;
	...
	public static function buscarRespuestas($id_autorizacion, $id_bateria,$opciones_array,$fi,$ff,$id_tipo_prueba) {
		
		$tabla_respuesta=self::buscarTablaResultados($id_bateria);
		$tabla_preguntas=self::buscarTablaPreguntas($id_bateria);
		$tabla_opciones=self::buscarTablaOpciones($id_bateria);
		
		$respuesta="";
		//echo "...............";
		//if ($id_bateria==6) {
			//BATERIA : HIC
			//echo "id_tipo_prueba=$id_tipo_prueba";
			//echo "<br>2)id_tipo_prueba=$id_tipo_prueba";
			if ($id_tipo_prueba==4) {
				//CC
				$sql = "select distinct(rhl.id_opcion), rhl.respuesta, phl.nombre
						from ".$tabla_respuesta." rhl, ".$tabla_preguntas." phl 
						where rhl.id_autorizacion=".$id_autorizacion." 
				...
				$data=DB::select($sql);
				foreach ($data as $data) {
					$respuesta .= '<td>'.str_replace(",","-",$data->respuesta).'</td>';
				}
				
			} elseif ($id_tipo_prueba==5) {
				//PHI
				$sql = "select distinct(phl.id_preguntas) as id_preguntas,
							ohl.id_opciones,
							rhl.respuesta as respuesta
						from ".$tabla_preguntas." phl, 
							".$tabla_opciones." ohl,
							".$tabla_respuesta." rhl
						where
							phl.id_pruebas=2 and rhl.id_pruebas=4
							and ohl.id_pregunta=phl.id_preguntas and 
							rhl.id_opcion=ohl.id_opciones and 
							rhl.id_autorizacion=".$id_autorizacion;
				//echo $sql."<br><br>";
				
				$respuesta_phi="";
				foreach ($opciones_array as $key=>$value) {
					$respuesta_phi[$value]=0;
				}
				$data=DB::select($sql);
				foreach ($data as $data) {
					//$opciones_array[]
					if ($data->respuesta==1)
						$respuesta_phi[$data->id_opciones]=1;
					//$respuesta .= '<td>'.str_replace(",","-",$data->respuesta).'</td>';
				}
				//echo "123456";
				...
				foreach ($respuesta_phi as $key=>$value) {
					$respuesta .= '<td>'.$value.'</td>';
				}
			} elseif ($id_tipo_prueba==6) {
				//IEP
				$sql = "select p.id_preguntas, o.id_opciones, r.id_opcion, r.*
					from ".$tabla_respuesta." r, ".$tabla_preguntas." p, ".$tabla_opciones." o
					where r.id_bateria=".$id_bateria." and ";
				
				if ($id_bateria>1)	
					$sql .= " r.id_autorizacion=$id_autorizacion and ";
					
				$sql .= " o.id_pregunta=p.id_preguntas and r.id_opcion=o.id_opciones
					order by p.orden,r.id_opcion";
				//echo $sql;
				$data=DB::select($sql);
				...
				foreach ($data as $data) {
					if ($data->respuesta==1)
						$resp_opc_mas[]=$data->id_opcion;
					elseif ($data->respuesta==-1)
						$resp_opc_menos[]=$data->id_opcion;
				}
				
				
				$i=0;
				foreach ($opciones_array as $key=>$value) {
					if (!empty($resp_opc_mas) && in_array($value,$resp_opc_mas))
						$respuesta .= '<td>( + )</td>';
					elseif (!empty($resp_opc_menos) && in_array($value,$resp_opc_menos))
						$respuesta .= '<td>( - )</td>';
					else
						$respuesta .= '<td>&nbsp;</td>';
				...
				$sql = "select rhl.*
						...
						where rhl.id_autorizacion=".$id_autorizacion." 
							and phl.id_preguntas=rhl.id_opcion 
							and rhl.id_pruebas=6
							and phl.id_pruebas=5 order by phl.orden";
				//echo $sql;
				$data=DB::select($sql);
				foreach ($data as $data) {
					$respuesta .= '<td>'.$opciones[$data->respuesta].'</td>';
				}
				//echo $sql."<br><br>";
				...
				$sql = "select rco.respuesta as rco_respuesta, pco.respuesta as pco_respuesta, 
						...
						from ".$tabla_respuesta." rco, preguntas_co pco
						where rco.id_opcion=pco.id_preguntas and 
							pco.id_preguntas>57 and rco.id_pruebas=$orden and 
							rco.id_autorizacion=".$id_autorizacion;
				//echo $sql; return;
				$data=DB::select($sql);
				foreach ($data as $data) {
					$respuesta .= '<td>'.$data->rco_respuesta.'</td>';
				}				
			}
		return $respuesta;
	}
	
	public static function buscarTablaPreguntas($id_bateria) {
		$sql = "select * from tablas_preguntas where id_bateria=".$id_bateria;
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->tabla;
	}	
	
	public static function buscarTablaOpciones($id_bateria) {
		$sql = "select * from tablas_opciones where id_bateria=".$id_bateria;
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->tabla;
	}

	public static function buscarTablaResultados($id_bateria) {
		$sql = "select * from tablas_resultados where id_bateria=".$id_bateria;
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->tabla;
	}
	
	public static function buscarTablaFuncion($id_bateria) {
		$sql = "select * from tablas_funciones where id_bateria=".$id_bateria;
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->tabla;
	}
	
	public static function buscarNombreBateria($id_bateria) {
		$sql = "select * from bateria where id=".$id_bateria;
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->nombre;
	}	

	public static function buscarOrdenPrueba($id_bateria,$nombre_prueba) {
		$sql = "select btp.orden, tp.nombre 
				from bateria_tipo_prueba btp, tipos_pruebas tp 
				where btp.id_bateria=".$id_bateria." and btp.id_tipo_prueba=tp.id 
					and lower(tp.nombre) like '%".$nombre_prueba."%'";
		//echo $sql."<br>";
		$data=DB::select($sql);
		foreach ($data as $data)
			return $data->orden;
