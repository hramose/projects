...
class EncuestaControllers extends Controller {
	...
	public function generar_resultado_hi ($id) {
		...
		/*********HABILIDADES INTELECTIVAS**************/
			...
			$tabla .= '
					<tr id="indice">
						<td align="right" colspan=2><strong>Indice de Potencial de Desempeño</strong></td>
			...
			$tabla .= '
				<table cellspacing="0">
					...
					<tr>
						<td align="left">Orientación al Cliente</td>
					...
					<tr id="indice">
						<td align="right" colspan=2><strong>Indice de Orientación al Éxito</strong></td>
	...
	<table cellspacing="0">
		...
		$sql = "select count(distinct(phl.id_preguntas)) as cantidad
				...
				where rhl.id_autorizacion=".$id_au." 
					...
					";
		//echo "Socio Estratégico del Negocio:".$sql."<br>";
		$data=DB::select($sql);
...
$tabla .= '
	...
	public function generar_resultado_octagon ($id) {
		...
		$nombre_bateria=strtolower($nombre_bateria);
			...
			<table>
				<tr>
					<th align="left" width="50%">Orientación a Resultados</th>
					<th align="center">Puntaje Bruto</th>
					<th align="center">Pentil</th>
					<th align="center">Categoría</th>
				</tr>';			
			...
			$tabla .='
				<tr id="indice">
					<td align="left">Determinación al Éxito</td>
			...
			$tabla .='
				<tr id="indice">
					<td align="left">Orientación al Detalle</td>
			...
			$tabla .='
				<tr id="indice">
					<td align="left">Valoración al Cliente</td>
