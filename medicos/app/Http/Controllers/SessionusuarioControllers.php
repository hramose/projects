...
class SessionusuarioControllers extends Controller
{
     ...
     * @return Response
     */
    public static function store($names,$lastnames,$id_usuario,$privilegio,$user,$pic)
    {
        //
        ...
        $sql = "insert into sesiones (fecha,hora,activa,nombre,apellido,id_usuario,privilegio,ip,usuario) ";
        $sql .= "values (current_date,now(),1,'$names','$lastnames',$id_usuario,'$privilegio',";
        $sql .= "'".$ip."','$user')";
        Session::put("user",$user);
        Session::put("name",$names." ".$lastnames);
